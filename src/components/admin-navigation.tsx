import { LayoutDashboard, Plus, Settings, User, LogOut, BarChart3 } from "lucide-react";
...
export function AdminNavigation({ currentUser, activeView, onViewChange, onLogout }: AdminNavigationProps) {
  const navItems = [
    { id: "dashboard", label: "Dashboard", icon: LayoutDashboard },
    { id: "analytics", label: "Report Analysis", icon: BarChart3 },
    { id: "debug", label: "Debug Images", icon: Settings }
  ];
